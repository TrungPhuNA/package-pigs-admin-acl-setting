                ...
                <div class="mt-2 mb-2">
                    <form class="row g-3 align-items-center">
                        ...
                        <div class="col-auto">
                            ...
                            <a href="{{ route('get.adm_acl_setting.tag.create') }}" class="btn btn-success">Thêm mới</a>
                        </div>
                    </form>
                </div>
                    ...
                    <table class="table table-striped table-sm">
                        ...
                        @foreach($tags ?? [] as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('get.adm_acl_setting.tag.update', $item->id) }}">Edit</a>
                                    <a href="javascript:;void(0)">|</a>
                                    <a href="{{ route('get.adm_acl_setting.tag.delete', $item->id) }}">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
