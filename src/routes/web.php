...
Route::group(['namespace' => 'Pigs\AdminAclSetting\Http\Controllers','prefix' => 'admin-acl','middleware' => ['web','check_login_admin']], function() {
    ...
    Route::group(['prefix' => 'setting'], function (){
        ...
        Route::post('','AdminAclSettingController@insertOrUpdateSetting');
    });
    ...
    Route::group(['prefix' => 'blog','namespace' => 'Blog'], function (){
        ...
        Route::group(['prefix' => 'article'], function (){
            ...
            Route::get('update/{id}','AdminAclSettingArticleController@edit')->name('get.adm_acl_setting.article.update');
            Route::post('update/{id}','AdminAclSettingArticleController@update');

            Route::get('delete/{id}','AdminAclSettingArticleController@delete')->name('get.adm_acl_setting.article.delete');
        });
    });
